...
0 0 * * * cd /root/works/LotteryScheduler && yarn execute:close:mainnet

# Draw lottery.
3 0,12 * * * cd ~/pancake-lottery-scheduler && yarn execute:draw:mainnet
5 0 * * * cd /root/works/LotteryScheduler && yarn execute:draw:mainnet

# Start lottery.
5 0,12 * * * cd ~/pancake-lottery-scheduler && yarn execute:start:mainnet
7 0 * * * cd /root/works/LotteryScheduler && yarn execute:start:mainnet
```
### Lottery Cron jobs
0 0 * * * root cd /root/works/LotteryScheduler && yarn execute:close:mainnet
5 0 * * * root cd /root/works/LotteryScheduler && yarn execute:draw:mainnet
7 0 * * * root cd /root/works/LotteryScheduler && yarn execute:start:mainnet
