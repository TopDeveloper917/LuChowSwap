...
const BalanceInputLottery: React.FC<BalanceInputProps> = ({
  value,
  placeholder = "0.0",
  onUserInput,
  currencyValue,
      ...
      <Flex justifyContent="flex-end">
        ...
        {switchEditingUnits && (
          <Flex alignItems="center" pl="12px">
            <SwitchUnitsButton scale="sm" variant="primary" onClick={switchEditingUnits}>
...
export default BalanceInputLottery;
