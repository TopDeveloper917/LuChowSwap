...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the Luchow lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == luchowLottery, "Only LuchowLottery");
    ...
    /**
     * @notice Set the address for the LuchowLottery
     * @param _luchowLottery: address of the Luchow lottery
     */
    function setLotteryAddress(address _luchowLottery) external onlyOwner {
        luchowLottery = _luchowLottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = ILuchowLottery(luchowLottery).viewCurrentLotteryId();
    }
}
