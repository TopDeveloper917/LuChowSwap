...
contract RandomNumberGenerator is VRFConsumerBase, IRandomNumberGenerator, Ownable {
     ...
     * @param _seed: seed provided by the ZonoV3 lottery
     */
    function getRandomNumber(uint256 _seed) external override {
        require(msg.sender == zonov3Lottery, "Only ZonoV3Lottery");
    ...
    /**
     * @notice Set the address for the ZonoV3Lottery
     * @param _zonov3Lottery: address of the ZonoV3 lottery
     */
    function setLotteryAddress(address _zonov3Lottery) external onlyOwner {
        zonov3Lottery = _zonov3Lottery;
    }
    ...
    function fulfillRandomness(bytes32 requestId, uint256 randomness) internal override {
        ...
        latestLotteryId = IZonoV3Lottery(zonov3Lottery).viewCurrentLotteryId();
    }
}
